...
<h2 class="text-2xl font-bold mb-6">📊 {{ __('Admin Dashboard') }}</h2>
...
<div class="grid md:grid-cols-3 gap-6 mb-6">
    ...
    <div class="bg-white/30 backdrop-blur border rounded-2xl p-6 shadow">
        <p class="text-gray-600">{{ __('Total Orders') }}</p>
    ...
    <div class="bg-white/30 backdrop-blur border rounded-2xl p-6 shadow">
        <p class="text-gray-600">{{ __('Avg Order Value') }}</p>
        <h3 class="text-2xl font-bold">
...
<!-- CHART -->
<div class="bg-white/30 backdrop-blur border rounded-2xl p-6 shadow">
    <h3 class="text-lg font-semibold mb-4">{{ __('Revenue Chart') }}</h3>
